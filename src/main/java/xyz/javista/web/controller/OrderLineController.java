...
public class OrderLineController {
    ...
    public OrderDTO createOrderItem(@PathVariable(name = "orderId") String orderId,
                                    @RequestBody @Valid CreateOrderLineItemCommand createOrderLineItemCommand) throws OrderLineItemException, DateTimeConverterException {
    ...
    public OrderLineNumberDTO updateOrderItem(@PathVariable(name = "orderId") String orderId,
                                              ...
                                              @RequestBody @Valid UpdateOrderLineItemCommand updateOrderLineItemCommand) throws OrderLineItemException, DateTimeConverterException {
